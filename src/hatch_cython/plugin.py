...
class CythonBuildHook(BuildHookInterface):
    ...
    def clean(self, versions: ListStr) -> None:
        files_to_remove = self.autogenerated_files + list(self.intermediate_files.keys()) + list(self.compiled_files.keys())
        ...
        self.app.display_info(f"Hatch-cython: intermediate {list(self.intermediate_files.keys())}")

...
class CythonBuildHook(BuildHookInterface):
    ...
    def clean(self, versions: ListStr):
        # this function seems to be ignored in hatch 1.12.0 when calling hatch clean
        # but it is called when cleaning before/after build is activated
        # to make hatch clean work, we need to add the files also to the artifacts
        ...
        # create an empty dir with name something at path of first file
        os.makedirs(os.path.join(self.root, "something"), exist_ok=True)

...
class CythonBuildHook(BuildHookInterface):
    ...
    def render_templates(self):
        for template in self.templated_files:
            outfile = template[:-3]
    ...
    def included_files(self):
        included_files = []
        # using self.build_config.builder.recurse_included_files() would end up in exception in c compiler
        for relative_path in set([f.relative_path for f in self.build_config.builder.recurse_selected_project_files()]):  # + self.precompiled_globs):
